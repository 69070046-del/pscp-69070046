...
```text
ให้สร้างinputโดยใช้split อยากได้outputมีทศนิยม2ตำแหน่ง ให้ดูตารางเพื่อเอามาชั่งน้ำหนักของ
```
...
```text
สร้างinput โดยใช้split และอีกตัวสร้างอีกบรรทัด ใช้if else เปรียบเทียบตามตาราง โดย้ิาค่าธรรมเนียมเริ่มต้น มาบวกกับค่าธรรมเนียนน้ำหนัก ที่คูณกับน้ำหนักของอินพุดมาเรียบร้อย เสร็จแล้วสั่งปริ้น
```
...
```text
เหมือนกับแผนแรก เพราะคิดมาถูกทางแล้วแต่ลืมfstring ให้มีทศนิยม2หลัก
```
...
```text
ดูว่าโปรแกรมคิดออกมาถูกต้องตามทศนิยมไหม
```
...
```text
ทำเองเกือบทั้งหมด แต่ลืมfstring
```
