...
```text
โจทย์ต้องการให้เราเช็กว่าในวันและเดือนนั้นจะเป็นฤดูอะไร ซึ่งในการนับวันนั้นคือหาก21 วันขึ้นไปและสามารถหาร3 ได้ลงตัวจะเป็นกาสรเริ่มฤดูใหม่ inputของเราก็เลยจะเป็นเดือน และวัน
```
...
Step 1: ตั้งinput
Step 2: ใช้if,else
Step 3: ทำยังไงให้มันรับคำสั่งว่าวันที่21เป็นต้นไปจะเลี่ยนฤดู
```
...
```text
ตั้งinputใช้เป็น if not... เพราะจะให้มันหารให้ได้หากมีเศษจะให้มันปัดไปเป็นฤดูอื่นเลย และตั้งเงื่อนไขเพิ่มมาว่าเดือนไหนจะให้เป็นฤดูอะไรบ้าง
```
...
```text
เป็นการเช็กว่าถ้าวันเกิน21 จะปัดไปเป็นฤดูอื่นให้เลยมั้ย
```
...
```text
ในเดือนนี้จะเป็นฤดูตามที่ต้องการไหม
```
