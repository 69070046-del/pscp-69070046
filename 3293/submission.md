...
```text
สร้างinputขึ้นมา 5ตัว และ  output จะมีกรอบรอบinputกำหนดตัวแปรให้เก็บอินพุทเป็นลิสต์ ใช้ for loop เพื่อให้มันสร้างกรอบวนได้ทุกบรรทัด
```
...
```text
สร้างinput 5ตัว สร้างตัวแปรเก็บinput ให้เป็นlist ใช้for loop
```
...
```text
คล้ายกับแผนแรกแต่ต้องเพิ่ม ตัวแปรที่จะเช็กความยาวของบรรทัดนั้นมากสุดต่อด้วยfoor loopวนในลิสต์ที่ได้สร้างไว้ เพื่อหาความยาวที่มากสุดของการสร้างกรอบนั้น พอเราได้ข้อความที่ยาวที่สุดมาเราก็นำมาบวก4 เป็นอีกตัวแปร เพราะมันคือการเพิ่มด้านข้างอย่างละ2 และสั่งปริ้น* ที่เป็นกรอบด้านบนโดยการเอาไปคูณ เสร็จแล้วสร้าง for loopเพิ่มแต่เป็นการวนแต่ละบรรทัด โดยการให้ระยะห่างเท่ากับข้อความที่ยาวที่สุดลบกับข้อความที่ข้อความของบรรทัดนั้น ๆ เพื่อหาระยะห่างที่ว่าง พอได้มาก็สร้างอีกตัวแปรให้เป็นระยะห่างของบรรทัดนั้น โดยเติมช่องว่าง และคูณกับจำนวนระยะห่างว่าควรยาวสุดเท่าไหร่ และสั่งปริ้นใน loopเพืื่อให้วนครบ เมื่อปริ้นในloopเสร็จ ก็สั่งปริ้นบรรทัดสุดท้ายที่เป็นกรอบทำเหมือนเดิทเลยคือการนำเครื่องหมาย * มาคูณกับความกว้างกรอบ
```
...
```text
พี่ที่รูู้จัก(ไม่ใช่พี่TA)
```

เขาช่วยอะไร

```text
ช่วยอธิบายการเอาบรรทัดมากสุดมาทำระยะห่างของกรอบ และการทำกรอบบน และล่าง
```

คุณยังทำอะไรด้วยตนเอง

```text
สร้าง input นำมาเข้าลิสต์ การสั่งปริิ้นการวนloop การใช้for loop
```
