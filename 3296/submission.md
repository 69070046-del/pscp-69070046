...
```text
เป็นการนำสีเดียวกันมารวมแล้วหาค่าเฉลี่ยของสีนั้นๆออกมา
```
...
```text
สร้างอินพุทขึ้นมาโดยมีการใช้map,spilt เพราะรับเป็นintในบรรทัดเดียวกัน แล้วหาค่าเฉลี่ยสีนั้นๆออกมา
```
...
```text
คล้ายกับแผนแรก แต่อินพุทต้องรับ6ตัวจากตอนแรกเข้าใจว่ารับสองตัว เพราะเป็น2บรรทัด แล้วก็นำอินพุทที่เป็นสีเดียวกันมาหาร2 ปัดเศษเพื่อหาค่าเฉลี่ยได้เลย
```
...
```text
ช่วยสอนในส่วนของอินพุท และใบ้ว่าเลขเอ้าพุทได้มายังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
รับอินพุทในการใช้mapถูก หาค่าเฉลี่ย และปริ้น
```
