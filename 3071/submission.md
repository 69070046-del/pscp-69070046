...
```text
โจทย์ต้องการให้ ดูว่ามีจำนวนนับเท่าไหนที่หารdแล้วจะได้เป็นเศษr โดยให้ใส่input4ตัว แล้วให้output ว่าตามจำนวนที่สอดคล้อง
```
...
```text
สร้างฟังชั่น สร้างinput 4 ตัว มีการใช้if
```
...
```text
คล้ายกับแผนแรก แต่มีการใช้ลูปเพิ่มเข้ามาเพื่อให้มันนับจำนวนได้จนกว่าจะจบ
```
...
```text
สร้างinput กำหนดตัวแปรภายในลูป ใช้if
```
