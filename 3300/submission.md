...
```text
คือต้องรับค่าl และ n โดยมีการใช้for loop รอบแรกให้ดูว่ามีอะไร รอบตต่อไปเพิ่มเท่าไร แล้วหาว่าnอยุ่รอบที่เท่าไหร
```
...
```text
เริ่มจากคำนวณจำนวนช่องของรอบแรก แล้วตรวจว่า N อยู่ในรอบนี้หรือไม่
ถ้ายังไม่อยู่ก็ลบจำนวนช่องของรอบนั้นออกจาก N แล้วไปดูรอบถัดไป
ทำซ้ำจนกว่า N จะอยู่ในรอบที่กำลังตรวจ
```
...
```text
คล้ายๆ วิธีแรกมีการรับค่าอินพุทเข้ามา ให้ตัวแปรkใช้เก็บหมายเลขรอบ ใช้for loop ถ้า N <= cells แสดงว่าเจอรอบที่ต้องการ จึง print(k) ถ้ายังไม่เจอ จะลบ cells ออกจาก N แล้วเพิ่ม k
```
...
```text
ช่วยอธิบายการloop การคิดเลข
```

คุณยังทำอะไรด้วยตนเอง

```text
การรับค่า การใช้break การปริ้น
