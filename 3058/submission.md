...
```text
โจทย์อยากรู้ว่าต้องใช้ก้อนเล็กให้น้อยที่สุดกี่ก้อนเราก็ต้องหาว่าใช้ก้อนใหญ่มากที่สุดกี่ก้อน
```
...
```text
ตั้งฟังชั่นสร้างอินพุท มีif else
```
...
```text
เอาgoal // 5 เพราะจะได้ใช้ก้อนใหญ่ตามต้องการใช้minเพิ่มด้สนเพราะคือการเลือกตามจำนวนจริงๆ และก็ตัวแปรa_small คือหาว่าขาดอยู่อีกกี่ก้อนเล็ก ใช้ในif else
```
...
```text
สร้างอินพุท สร้างเทสเคส ใช้if else
```
