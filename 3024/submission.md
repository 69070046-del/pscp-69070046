...
```text
 โจทย์ต้องการให้แสดงoutputออกมาว่าหาก คนมาดูคะแนนจะรู้สึกยังไงตามที่โจทย๋ได้กำหนดมา
```
...
```text
เริ่มจากการสร้างinputขึ้นมาตั้งตัวแปรขึ้นมาใช้float แล้วก็ใช้คณิตศาตร์การคำนวนต่างๆ
```
...
```text
เริ่มจากการสร้างinputขึ้นมาตั้งตัวแปรขึ้นมาใช้float แล้วก็ใช้คณิตศาตร์การคำนวนต่างๆ คือในตัวแปรmininumมาจากการหาว่าค่าต่ำสุดที่เป็นไปได้นั้นคือเท่าไหร่ เนื่องจากตัวแรกคือค่าสูงสุดอีกสองตัวเลยต้องมาเทียบกันว่าอันไหนจะเป็นค่าต่ำสุด หาโดยการเอาคะแนนรวม(total) ลบกับ จำนวนที่มากสุดและคูนด้วยสอง หลังจากนั้นก้จะใช้if else  เอาจำนวนมากสุด ลบกับจำนวนน้อยสุดแล้วให้เอาค่านั้นมามากกว่า 2 และelse อีกตัวคือมากกว่าเท่ากับิ2
```
...
```text
้อยากรู้ว่าเลขเยอะๆจะเป็นยังไง
```
