...
```text
โจทย์อยากให้เปลี่ยนหน่วยของอุณหภูมิจากสิ่งหนึ่งเป็นอีกหน่วยนึง ซึ่งโจทย์ให้สูตรการเปลี่ยนหน่วยอุณหภูมิ
```
...
```text
Step 1: ตั้งinput
Step 2: ใช้if elseในการตั้งหน่วยแต่ละตัวเพื่อให้เอาไปเข้าสูตรที่โจทย์ได้ให้มา
Step 3: ตั้งตัวแปรเพิ่ม 
```
...
```text
ตั้งinputขึ้นมา และตั้งตัวแปรต่างๆให้เท่ากับ0จะได้ไม่ติดpep8 ใช้ตัวแปรที่ตั้งขึ้นมาใหม่ไปใช้ในสูตรแต่สูตรอันนี้จะต้องกลับให้มันเท่ากับตัวแปรcelciiusมันด้วย ทำแบบนี้กับทุกสูตร และตั้งifขึ้นมาใหม่โดยรอบนี้ให้นำอีกตัวแปรมาเท่ากับตัวแปรแรก และยัดเข้าสูตรตามเดิม และสั่งปริ้นโดยอย่าลืมใช้fstringเพื่อให้ทศนิยมในoutputออกมามี2ตำแหน่งตามที่โจทย์ต้องการ
```
...
เขียน test cases อย่างน้อย 3 กรณีที่ล องเองหรือออกแบบเอง
...
```text
ดูว่ามันจะเอาเข้าสูตรตามที่กำหนดไหม
```
...
```text
ช่วยสอนเรื่องการสร้างตัวแปรออกมาเพื่อให้สลับสมการและจะได้นำเข้าสูตรที่ถูกต้อง
```

คุณยังทำอะไรด้วยตนเอง

```text
ตั้งinput การสลับฝั่งสูตร ปริ้นfstring
```
