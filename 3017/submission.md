...
```text
โจทย์ให้คิดค่าบริการลูกค้าเพิ่ม10%ของราคาอาหาร และเครื่องดื่ม และกำหนดค่าบริการว่าจะคิดเริ่มต้นที่50แต่ไม่เกิน1000บาท และก็คิดภาษีเพิ่มอีก7% จากราคารวมทั้งหมด ให้หาราคาจ่ายท้ายสุดที่รวมภาษีแล้ว กำหนดinputเป็นราคาอาหารรวมเครื่องดื่มที่สั่ง outputคือราคาสุดท้ายที่ลูกค้าต้องจ่าย
```
...
```text
Step 1: สร้างinputขึ้นมาคือtotal
Step 2: กำหนดค่าบริการขึ้นมาเป็นcharge และนำไปคูณกับtotalที่สร้างขึ้น
Step 3: ใช้if else
Step 4: เริ่มจากif ต่อด้วยใช้charge<50 ต่อมาใช้charge=50 เพราะโจทย์ต้องการให้คิดอย่างน้อย50ก็คือขั้นต่ำเริ่มที่50 
Step 5: ใช้elif เป็นcharge>1000 ต่อมาใช้charge=1000 เพราะโจทย์ต้องการว่าไม่เกิน1000
Step 6: คิดภาษีโดยการตั้งให้เป็นแีกตัวแปรว่าvat ตามโจทย์คือจะคิดภาษีเพิ่ม 7% หรือก็คือ 0.07 จากค่าอาหาร เครื่องดื่ม และค่าบริการ เลยตั้งให้เป็น vat = ค่าภาษีที่เพิ่มมาคูณกับ total+ค่าบริการ
Step 7: ตั้งค่าตัวแปรใหม่เป็นbillเพื่อคิดราคาสุดท้ายึิอราคารวมภาษี ค่าบริการ และราคาน้ำและอาหาร
Step 8: สั่งprint(bill)
```
...
```text
เหมือนกัน แต่ขาดอย่างเดียวคือลืม  fstring.2f เพื่อเป็นการเอาทศนิยมเพียงแค่2ตำแหน่ง
```
...
```text
เรื่องการใช้ fstring.2f
```

คุณยังทำอะไรด้วยตนเอง

```ตั้งinputตัวแปรต่างๆ การใช้if elif 
