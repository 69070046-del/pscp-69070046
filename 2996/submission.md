...
```text
เริ่มจากการพิมพ์docstringขึ้นมา และสร้าตัวแปรเป็นinput และได้สั่งprintโดยที่ภายในนั้นให้ปร้นออกมาว่าถ้าจะเปบี่ยนจากด้านหน้าให้มันกลับหลังต้องใช้้[::-1] และโจทย์ได้ให้เปลี่ยนตัวอักษรทุกตัวเป็นตัวพิมพ์เล็ฏจึงใช้คำสั่งต่อมาเป็น.lower() ภายในคำสั่งปริ้น
...
```text
 เริ่มจากการพิมพ์docstring และสร้างตัวแปรว่าnameโดยให้เป็นinput ต่อมาโจทย์ได้ให้นำตัวอักษรมาสลับกัน จึงได้ใช้คำสั่งprintซึ่งภายในคำสั่งนี้เราต้องการให้มันสลับจากหน้าไปหลังจึงได้ใช้คำสั่ง[::-1] และโจทย์อยากให้ทุกตัวอักษรเป็นตัวเล็กจึงได้ใช้คำสั่งต่อว่า .lower() ภายในปริ้น
...
```
Step 1: สร้างdocstring
Step 2: สร้างตัวแปรinput
Step 3: ทำยัไงให้มันสลับจากหน้าไปหลัง และตัวเล็กลง
```
...
```text
สร้างdocstring สร้างinput และprintให้มันสลับจากหน้าไปหลัง และทำให้ตัวเล็กลง
...
```text
มีตัวใหญ่ และเล็กเพื่อเช็คว่าตัวเล็กทุกตัวหรือไม่
...
```text
ช่วยแนะนำให้ใช้แบบไหนถึงจะสลับตัวหลังมาหน้าได้ และ เตือนไม่ให้ลืมให้ทุกตัวเป้นตัวพิมพ์เล็ก
